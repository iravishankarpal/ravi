...
function Home() {
  return (
    <>
      <div id='Home shapedividers_com-2724' className='home'>
      <div class="custom-shape-divider-top-1633480566">
    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
        ...
        <div className="container-fulid">
          <div className="container home-start">
            ...
            <div className="col-sm-6 order-md-last  raviShankar-img-container">
                <div className="ravishankar-img">
                  <img src={ravi} alt="ravishankar pf" />
                </div>
              </div>

              <div className="col-sm-6 ravishankar-hi">
                <div className="intro">
                  <h1>Ravi Shankar</h1>
                </div>
              </div>
